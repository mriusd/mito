...
type SidebarHistoryTipProps = {
  anchorRef: RefObject<HTMLButtonElement | null>;
  open: boolean;
  onDismiss: () => void;
};

export function SidebarHistoryTip({ anchorRef, open, onDismiss }: SidebarHistoryTipProps) {
    ...
    <>
      ...
      >
        ...
        <p className="text-[11px] leading-relaxed text-gray-200">
          Tap the history icon to open{' '}
          <span className="font-semibold text-yellow-400">Market View</span>
          {' '}— browse past markets, top traders, and wallet trades.
        </p>
        <button
          type="button"
