    ...
    <div className="mt-2 pt-2 border-t border-gray-800">
      ...
      {!loading && !err && (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-3 gap-y-2">
          <MiniLineCanvas title="Win rate %" dates={dates} values={wr} stroke="#34d399" yFmt="pct0" />
          <MiniLineCanvas title="Profit rate %" dates={dates} values={pr} stroke="#60a5fa" yFmt="pct0" />
          <MiniLineCanvas title="PnL $" dates={dates} values={pnl} stroke="#fbbf24" yFmt="money" />
          <MiniLineCanvas title="ROI %" dates={dates} values={roi} stroke="#f472b6" yFmt="pct1" />
        </div>
      )}
    </div>
  );
